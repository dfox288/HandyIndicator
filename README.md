...
A Fabric mod that shows a subtle visual indicator on container blocks when they contain items. Targets Minecraft 26.3.
...
[![Modrinth](https://img.shields.io/badge/Modrinth-handy--indicator-green)](https://modrinth.com/project/handy-indicator)
...
Without these, all features work with sensible defaults. You can also edit `config/handyindicator.json` manually.
